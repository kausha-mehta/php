...
jQuery.imgAreaSelect.init = function(img, options) {
    ...
    function update(resetKeyPress) {
        ...
        if (resetKeyPress !== false) {
            if (jQuery.imgAreaSelect.keyPress != docKeyPress)
                jQuery(document).unbind(jQuery.imgAreaSelect.keyPress, jQuery.imgAreaSelect.onKeyPress);
            if (options.keys)
    ...
    this.setOptions = function(newOptions) {
        ...
        if (newOptions.keys)
            options.keys = jQuery.extend({shift: 1, ctrl: 'resize'}, newOptions.keys === true ? {} : newOptions.keys);
